...
function InformationPanel({ city, lat, lon, results }: Props) {
    return (
        <div className="text-white p-10 bg-gradient-to-br from-[#394F68] to-[#183B7E]">
            ...
            <div className="mt-5 flex items-center justify-between space-x-10">
                <div>
                    ...
                    <p className="text-sm italic pt-2 font-extralight">
            ...
            <div className="flex items-center justify-between">
                <div>
                    <Image
                        ...
                        alt={weatherCodeToString[results.current_weather.weathercode].lable}
                        width={75}
                        height={75}
                    />
                    <div className="flex items-center justify-between space-x-10">
                        ...
                        <p className="text-center font-extralight text-lg">
                            {weatherCodeToString[results.current_weather.weathercode].lable}
                        </p>
                    </div>
                </div>
            </div>
            <div className="space-y-2 py-2">
                <div className="flex items-center space-x-2 px-4 py-3 border border-[#6F90CD] rouded-md bg-[#405885]">
